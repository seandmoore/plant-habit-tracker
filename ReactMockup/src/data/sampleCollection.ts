import type { UserPlant } from '@/domain/types';
...
/**
 * Dates are relative to launch so the preview always shows a plant that is overdue, one that
 * is comfortably upcoming, and one in between — the three states the Today screen has to
 * render — no matter when someone opens it.
 */
export const createSamplePlants = (): UserPlant[] => [
  ...
  },
  {
    id: 'sample-sunny',
    nickname: 'Sunny',
    speciesId: 'ocimum-basilicum',
    commonName: 'Basil',
    scientificName: 'Ocimum basilicum',
    environment: 'outdoorContainer',
    light: 'direct',
    locationName: 'Kitchen patio',
    dateAdded: relativeDate(26),
  ...
  },
  {
    ...
    light: 'low',
    locationName: 'Office',
    dateAdded: relativeDate(120),
    baselineWateringDays: 18,
    reminderEnabled: true,
    reminderHour: 10,
    notes: 'Use extra caution not to overwater.',
    careEvents: [
      { id: 'event-sage-1', kind: 'watered', timestamp: relativeDate(14), note: 'Pot felt light.' },
    ],
  },
];
